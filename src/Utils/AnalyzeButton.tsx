    ...
    <StyledWrapper>
      <div className="sp">
        <button className="sparkle-button">
          ...
          <span className="text">Analyze Site</span>
        </button>
...
const StyledWrapper = styled.div`
  ...
  .text {
  /* Remove the translation to ensure the text isn’t shifted off */
  /* translate: 2% -6%; */
  letter-spacing: 0.01ch;
  /* Use a solid silver gradient (which will appear as a solid color) */
